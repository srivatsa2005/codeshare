...
const SE03 = () => {
  const [productImage, setProductImage] = useState('red.png'); 
      ...
      <div className="flex-box">
        <div className="left">
          <div className="big-img">
            <img src={productImage} alt="Rhyno SE03" />
          </div>
          <div className="images">
            <div className="small-img">
              <img src="red.png" alt="Red SE03" onClick={() => showImg('red.png')} />
            </div>
            <div className="small-img">
              <img src="red.png" alt="Blue SE03" onClick={() => showImg('red.png')} />
            </div>
          </div>
        </div>
        <div className="right">
          <div className="url"><p>Home - Product - SE03</p></div>
          <div className="pname">SE03</div>
